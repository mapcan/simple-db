...
public class TupleDesc implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (items.size() != ((TupleDesc)o).numFields()) {
            return false;
        }
        for (int i = 0; i < items.size(); i++) {
            Type a = items.get(i).fieldType;
            Type b = ((TupleDesc)o).getFieldType(i);
            if (!a.equals(b)) {
                return false;
            }
        }
    ...
    public String toString() {
        ...
        for (int i = 0; i < items.size()-1; i++) {
            desc += items.get(i).toString();
            desc += ", ";
        }
        desc += items.get(items.size()-1).toString();
        return desc;
    }
}
